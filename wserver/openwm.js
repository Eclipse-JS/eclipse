...
let terminal = Applications.find((app) => {
  return app.name == "terminal";
});

kernel.stdout(" - Starting panel...\n");

let nepo = Applications.find((app) => {
  return app.name == "nepo";
});
...
if (localStorage.getItem("openwm_init.cfg") !== null)
  localStorage.setItem("openwm_init.cfg", "terminal");
