...
const babelConfig = require("./babelConf.json");
...
function compileBabel(file) {
  console.log("uhh hamburger");
  const code = fs.readFileSync(file, "utf-8");
  const transformed = babel.transformSync(code, babelConfig);
