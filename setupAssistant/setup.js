...
kernel.stdout("3. Desktop, base system + multimedia utilities + desktop utilities\n");
...
if (stdin == "1") {
    ...
    kernel.stdout("Please wait...");
    localStorage.setItem("autostart.rc", "btm.sh");
    localStorage.setItem("fselect_manifest", '["/app/manifest.json", "/av/manifest.json"]');
    ...
    localStorage.setItem("fselect_manifest", '["/app/manifest.json", "/av/manifest.json", "/wserver/manifest.json", "/demos/manifest.json"]');
    ...
    kernel.stdout("Please wait...");
    localStorage.setItem("autostart.rc", "wserv");
    localStorage.setItem("fselect_manifest", '["/app/manifest.json", "/av/manifest.json", "/wserver/manifest.json", "/demos/manifest.json", "/programming/manifest.json"]');
